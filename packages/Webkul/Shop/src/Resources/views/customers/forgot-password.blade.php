...
>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        ...
        <!-- Form Container -->
        <div
            class="m-auto w-full max-w-[550px] rounded-[32px] border border-zinc-200 bg-white p-14 shadow-[0_20px_50px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_30px_60px_rgba(0,0,0,0.08)] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0"
        >
                ...
                <x-shop::form :action="route('shop.customers.forgot_password.store')">
                    ...
                    <x-shop::form.control-group class="max-sm:mb-1.5">
                        ...
                        <x-shop::form.control-group.control
                            type="email"
                            class="rounded-2xl border-zinc-300 px-6 py-4 transition-all duration-300 focus:border-navyBlue max-sm:py-1.5"
                            name="email"
                    ...
                    <!-- Submit Button -->
                    <div class="mt-10 flex flex-wrap items-center gap-9 max-sm:mt-0 max-sm:justify-center max-sm:text-center">
                        <button
                            class="primary-button m-0 mx-auto block w-full max-w-[374px] rounded-2xl px-11 py-4 text-center text-base shadow-[0_10px_20px_rgba(6,12,59,0.15)] transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] max-md:max-w-full max-md:rounded-lg max-md:py-3 max-sm:py-1.5 max-sm:text-sm ltr:ml-0 rtl:mr-0 font-semibold"
                            type="submit"
                        >
